...
class HotelManager:
    ...
    room_key = "28d32fa25abce85a4f01bebd32cf6a7364f532727af401c1561eefec02cf1cf9"

    try:
        # Llama a la función guest_checkout con la room_key válida
        resultado = guest_checkout(room_key)

        # Verifica si la función devuelve True
        if resultado:
            print("La salida del huésped se registró correctamente.")
        else:
            print("Hubo un problema al registrar la salida del huésped.")
    except Exception as e:
        print("Se produjo un error durante la ejecución de guest_checkout:", e)