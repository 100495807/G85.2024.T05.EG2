...
class TestGuestCheckout(unittest.TestCase):
    ...
    def test_guest_checkout_invalid_room_key(self):
        ...
        with self.assertRaises(HotelManagementException):
            # No es una cadena
            HotelManager.guest_checkout("123")
        with self.assertRaises(HotelManagementException):
            # Longitud incorrecta
            HotelManager.guest_checkout("123")
